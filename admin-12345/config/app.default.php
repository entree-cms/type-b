...
return [
    ...
    'Site' => [
        ...
        'titleSeparator' => env('ADMIN_TITLE_SEP'),
        'template' => env('ADMIN_THEME'),
    ],
    ...
    'App' => [
        ...
        'defaultLocale' => env('DEFAULT_LOCALE', 'ja_JP'),
        'defaultTimezone' => env('DEFAULT_TIMEZONE', 'Asia/Tokyo'),
        'base' => env('ADMIN_BASE'),
        'baseSite' => env('SITE_BASE'), // App.base value of site-side.
        'dir' => 'src',
        'webroot' => 'webroot',
        'wwwRoot' => WWW_ROOT,
