...
/**
 * PostsPostCategories Model
 */
class PostsPostCategoriesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('posts_post_categories');
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->isUnique(['post_id', 'post_category_id']));
