...
<body>
    ...
    <div class="error-contents">
        ...
        <p class="customize">
            ...
            <em><?= APP_DIR . DIRECTORY_SEPARATOR . 'Template' . DIRECTORY_SEPARATOR . $siteInfo['template'] . DIRECTORY_SEPARATOR . 'Error' . DIRECTORY_SEPARATOR . $this->fetch('templateName') ?></em>
        </p>
        <?php endif; ?>
    </div>
